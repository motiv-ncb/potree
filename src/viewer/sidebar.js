...
export class Sidebar{
	...
	initScene(){
        ...
        let fillingID = tree.jstree('create_node', "#", { "text": "<b data-i18n='displacement.filling_boxes'>Filling boxes</b>", "id": "fillingBoxVolume" }, "last", false, false);

		let measurementBoxID = tree.jstree('create_node', "#", { "text": "<b data-i18n='displacement.measurement_boxes'>Measurement boxes</b>", "id": "measurementBoxVolume" }, "last", false, false);
		...
		let onVolumeAdded = (e) => {
            ...
            if(volume.constructor.name == "TransformedBoxVolume"){             
                ...
                if(volume.volumeType == "Volume" || volume.volumeType == "Clipping"){
                    ...
                    node = createNode(fillingID, volume.name, icon, volume);
                }
