...
import { MathUtils } from "../libs/three.js/build/three.module.js";
import { Vector2, Vector3, Vector4 } from "../libs/three.js/build/three.module.js";
import { Matrix4 } from "../libs/three.js/build/three.module.js";
import { Box3 } from "../libs/three.js/build/three.module.js";
// cmair class
export class Annotation_Custom extends EventDispatcher {
    constructor (args = {}) {
        super();
        ...
        let iconPin = exports.resourcePath + '/icons/pin_location_3d.png';

        this.domElement = $(`	
        <div class="annotation-custom" oncontextmenu="return false;">	
            <div class="annotation-pin">
                <img src="${iconPin}" style="width: 35px !important" />
            </div>								
            <div class="annotation-titlebar" style="opacity: 0.7 !important">
                <span class="annotation-label"></span>
            </div>
            <div class="annotation-description" style="opacity: 0.7 !important>
